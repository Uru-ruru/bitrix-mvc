...
class ElementQueryTest extends ModelTestCase
{
    ...
    protected function createQuery($bxObject)
    {
        ...
        return new ElementQuery($bxObject, 'Uru\Tests\BitrixModels\Stubs\TestElement');
    }
    ...
    {
        $bxObject = m::mock('obj');
        $query = m::mock('Uru\BitrixModels\Queries\ElementQuery[getList]', [$bxObject, 'Uru\Tests\BitrixModels\Stubs\TestElement', 1]);
...
//    }
    ...
    public function testPaginate()
    {
        ...
        $query = m::mock('Uru\BitrixModels\Queries\ElementQuery[getList, count]', [null, 'Uru\Tests\BitrixModels\Stubs\TestElement'])
