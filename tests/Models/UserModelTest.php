...
use Uru\Tests\BitrixModels\Stubs\BxUserWithAuth;
use Uru\Tests\BitrixModels\Stubs\BxUserWithoutAuth;
...
class UserModelTest extends ModelTestCase
{
    ...
    {
        $user = m::mock('Uru\Tests\BitrixModels\Stubs\TestUser[save]', [1]);
