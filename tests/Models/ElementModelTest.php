...
use Uru\Tests\BitrixModels\Stubs\TestSection;
use Uru\Tests\BitrixModels\Stubs\TestUser;
use Mockery as m;

class ElementModelTest extends ModelTestCase
{
    ...
    public function testDelete()
    {
        ...
        $element = m::mock('Uru\Tests\BitrixModels\Stubs\TestElement[onAfterDelete, onBeforeDelete]', [1])
    ...
    public function testSave()
    {
        ...
        $element = m::mock('Uru\Tests\BitrixModels\Stubs\TestElement[get,onBeforeSave,onAfterSave,onBeforeUpdate,onAfterUpdate]', [1])
            ->shouldAllowMockingProtectedMethods();
    ...
    {
        $element = m::mock('Uru\Tests\BitrixModels\Stubs\TestElement[save]', [1]);
