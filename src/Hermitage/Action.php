...
class Action
{
    ...
    public static function deleteIBlockElement(\CBitrixComponentTemplate $template, $element, ?string $confirm = null): string
    {
        ...
        $template->AddDeleteAction('iblock_element_'.$element['ID'], $link, \CIBlock::GetArrayByID($element['IBLOCK_ID'], 'ELEMENT_DELETE'), ['CONFIRM' => $confirm]);
    ...
    public static function deleteIBlockSection(\CBitrixComponentTemplate $template, $section, ?string $confirm = null): string
    {
        ...
        $template->AddDeleteAction('iblock_section_'.$section['ID'], $link, \CIBlock::GetArrayByID($section['IBLOCK_ID'], 'SECTION_DELETE'), ['CONFIRM' => $confirm]);
    ...
    public static function deleteHLBlockElement(\CBitrixComponentTemplate $template, $element, ?string $label = null, ?string $confirm = null): string
    {
        ...
        $template->AddDeleteAction('hlblock_element_'.$element['ID'], $link, $label, ['CONFIRM' => $confirm]);
    ...
    public static function addForIBlock(\CBitrixComponent|\CBitrixComponentTemplate $componentOrTemplate, $iblockId, array $options = []): void
    {
        if (!$GLOBALS['APPLICATION']->GetShowIncludeAreas()) {
            return;
        }
